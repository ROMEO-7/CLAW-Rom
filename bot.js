...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('CLAW-RomEo 𝚠𝚘𝚛𝚔𝚒𝚗𝚐 ' + config.WORKTYPE + ' 𝚗𝚘𝚠 🍃'));
    ...
    setInterval(async () => { 
        ...
        while (getGMTh == 7 && getGMTm == 01) {
            ...
            return await conn.sendMessage(conn.user.jid, '*[ DAILY ANNOUNCEMENTS ROMEO ]*\n\n' + announce, MessageType.text);
        }
...
*/
                        ...
                        try {
                            ...
                            if (config.NOLOG === 'off') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ ROMEO ~______~*' +
